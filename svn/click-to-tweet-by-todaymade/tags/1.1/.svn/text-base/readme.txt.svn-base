...
Donate link: http://todaymade.com/click-to-tweet
...
This is a free plugin by CoSchedule, the [all-in-one content marketing editorial calendar for WordPress](http://coschedule.com).
...
3. Place '<?php do_action('plugin_name_hook'); ?>' in your templates as needed.

== Frequently Asked Questions ==

Read our help section to learn more about Click To Tweet: [http://todaymade.com/click-to-tweet](http://todaymade.com/click-to-tweet)
...
Find out more here: [http://todaymade.com/click-to-tweet](http://todaymade.com/click-to-tweet)
